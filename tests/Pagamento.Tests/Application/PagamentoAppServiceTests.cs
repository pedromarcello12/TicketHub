...
public class PagamentoAppServiceTests
{
    ...
    public async Task CriarAsync_QuandoIngressoExiste_DeveCriarESalvar()
    {
        ...
        var request = new CriarPagamentoRequest(ingressoId, 250m, MetodoPagamento.CartaoCredito);
    ...
    public async Task CriarAsync_QuandoIngressoNaoExiste_DeveLancarExcecaoENaoSalvar()
    {
        ...
        var request = new CriarPagamentoRequest(ingressoId, 250m, MetodoPagamento.Pix);
    ...
    {
        var pagamento = new EntidadePagamento(Guid.NewGuid(), 100m, MetodoPagamento.Pix);
        ...
        await _eventoPublisher.Received(1).PublicarStatusAlteradoAsync(
            pagamento.Id, pagamento.IngressoId, pagamento.Valor, "Aprovado", Arg.Any<CancellationToken>());
    }
    ...
    public async Task ListarAsync_DeveMapearTodosOsResultados()
    {
        var pagamentos = new List<EntidadePagamento>
        {
            ...
            new(Guid.NewGuid(), 200m, MetodoPagamento.Boleto)
        };
